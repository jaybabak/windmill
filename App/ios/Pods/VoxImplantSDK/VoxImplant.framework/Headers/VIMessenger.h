 ...
 * * the current user
 * * other users of the same [child account](https://voximplant.com/docs/references/httpapi/managing_accounts#addaccount)
 ...
 */
- (VIConversation *)recreateConversation:(VIConversationConfig *)config
                                    uuid:(NSString *)uuid
