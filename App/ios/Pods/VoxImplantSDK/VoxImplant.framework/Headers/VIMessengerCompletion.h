 ...
 *                is called.
 *                ```objectivec
 *                [messenger getUserByIMId:@42
 *                              completion:[VIMessengerCompletion
 *                                      success:^(VIUserEvent *event) {
 *                                          NSLog(@"User: %@", event.user.displayName);
 *                                      } failure:^(VIErrorEvent *event) {
 *                                          NSLog(@"Error: %@", event.errorDescription);
 *                                      }]];
 *                ```
